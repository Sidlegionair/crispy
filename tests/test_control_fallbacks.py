...
class ControlFallbacks(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.states.update({
            ...
            'sensor.crispy_forecast_current_window_hours': '2',
            'sensor.crispy_forecast_window_status': 'closing',
            'sensor.crispy_forecast_heat_onset_hours': '4',
            'input_boolean.crispy_precooling': 'on',
